...
class critic(tf.keras.Model):
    ...
    def __init__(self):
        ...
        self.l6 = tf.keras.layers.LSTM(denseLayerNL_2)
        # self.l7 = tf.keras.layers.LSTM(denseLayerNL_21)
        self.l8 = tf.keras.layers.LSTM(denseLayerNL_3)
...
if exists('D:\ekpa\diplomatiki\Wizard-Werdna-Ring-Adventure\model_LSTM_12_12_21\steps.txt'):
    f = open('D:\ekpa\diplomatiki\Wizard-Werdna-Ring-Adventure\model_LSTM_12_12_21\steps.txt','r')
    total_steps = int(f.read())
    f.close()
initial_learning_rate = 1e-5*0.9**(total_steps/(h_step*decay_steps))
agentoo7 = agent(initial_learning_rate)
f = open('D:\ekpa\diplomatiki\Wizard-Werdna-Ring-Adventure\model_LSTM_12_12_21\episodes.txt','r')
episodes_text = int(f.read())
f.close()
if exists('D:\ekpa\diplomatiki\Wizard-Werdna-Ring-Adventure\model_LSTM_12_12_21\ actor_model.data-00000-of-00001'):
    print("actor model is loaded")
    agentoo7.actor.built = True
    agentoo7.actor.load_weights('D:\ekpa\diplomatiki\Wizard-Werdna-Ring-Adventure\model_LSTM_12_12_21\ actor_model')
if exists('D:\ekpa\diplomatiki\Wizard-Werdna-Ring-Adventure\model_LSTM_12_12_21\ critic_model.data-00000-of-00001'):
    print("critic model is loaded")
    agentoo7.critic.built = True
    agentoo7.critic.load_weights('D:\ekpa\diplomatiki\Wizard-Werdna-Ring-Adventure\model_LSTM_12_12_21\ critic_model')
...
for s in range(episode):
    ...
    while not done:
        ...
        if done:
            ...
            if s%100 == 0 and s != 0:
                agentoo7.actor.save_weights('.\model_LSTM_12_12_21\ actor_model')
                agentoo7.critic.save_weights('.\model_LSTM_12_12_21\ critic_model')
                f = open('D:\ekpa\diplomatiki\Wizard-Werdna-Ring-Adventure\model_LSTM_12_12_21\episodes.txt','w')
                f.write(str(episodes_text + 100))
                f.close()
                f = open('D:\ekpa\diplomatiki\Wizard-Werdna-Ring-Adventure\model_LSTM_12_12_21\episodes.txt','r')
                episodes_text = int(f.read())
                f.close()
                f = open('D:\ekpa\diplomatiki\Wizard-Werdna-Ring-Adventure\model_LSTM_12_12_21\steps.txt','w')
