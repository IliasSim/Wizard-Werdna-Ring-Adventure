...
class agent():
    ...
    def act(self,state,playerstatus,gameText):
        ...
        prob,_ = self.actor_critic(state,playerstatus,gameText)
        print(prob)
        prob = prob.numpy()
    ...
    def learn(self, states,playerstatus,gameTexts, G,actions):
        ...
        with tf.GradientTape() as tape:
            p,v = self.actor_critic(states,playerstatus,gameTexts, training=True)
        ...
        self.a_opt.apply_gradients(zip(grads, self.actor_critic.trainable_variables))
...
f.close()
if exists('D:\ekpa\diplomatiki\Wizard-Werdna-Ring-Adventure\modelLSTM_Imp_15_12_21_nreplay_n_step_truncate_3_common\ actor_model2.data-00000-of-00001'):
    print("actor model is loaded")
    agentoo7.actor.built = True
    agentoo7.actor.load_weights('D:\ekpa\diplomatiki\Wizard-Werdna-Ring-Adventure\modelLSTM_Imp_15_12_21_nreplay_n_step_truncate_3_common\ actor_model2')
if exists('D:\ekpa\diplomatiki\Wizard-Werdna-Ring-Adventure\modelLSTM_Imp_15_12_21_nreplay_n_step_truncate_3_common\ critic_model2.data-00000-of-00001'):
    print("critic model is loaded")
    agentoo7.critic.built = True
    agentoo7.critic.load_weights('D:\ekpa\diplomatiki\Wizard-Werdna-Ring-Adventure\modelLSTM_Imp_15_12_21_nreplay_n_step_truncate_3_common\ critic_model2')
episode = 10000
ep_reward = []
total_avgr = []
dfrewards = []
    ...
    while not done:
            ...
            for i in range(len(train_states)+3):
                ...
                if t >= 0:
                    if (t + n_step) < (len(train_states)):
                        ...
                        _,train_value_of_state = agentoo7.actor_critic(train_state_t_n,train_playerstatus_T_t_n,train_gametext_t_n,training=True)
        ...
        if done: 
            if s%100 == 0 and s != episodes_text:
                agentoo7.actor_critic.save_weights('.\modelLSTM_Imp_15_12_21_nreplay_n_step_truncate_3_common\ actor_model2')
                agentoo7.critic.save_weights('.\modelLSTM_Imp_15_12_21_nreplay_n_step_truncate_3_common\ critic_model2')
                f = open('D:\ekpa\diplomatiki\Wizard-Werdna-Ring-modelLSTM_Imp_15_12_21_nreplay_n_step_truncate_3_common\model_LSTM_Imp_15_12_21_10\episodes.txt','w')
