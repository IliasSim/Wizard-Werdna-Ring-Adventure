...
if exists('D:\ekpa\diplomatiki\Wizard-Werdna-Ring-Adventure\model_LSTM_Imp_15_12_21_11\steps.txt'):
    f = open('D:\ekpa\diplomatiki\Wizard-Werdna-Ring-Adventure\model_LSTM_Imp_15_12_21_11\steps.txt','r')
    total_steps = int(f.read())
    f.close()
agentoo7 = agent()
replay_memory = replay(memory_size)
f = open('D:\ekpa\diplomatiki\Wizard-Werdna-Ring-Adventure\model_LSTM_Imp_15_12_21_11\episodes.txt','r')
episodes_text = int(f.read())
f.close()
if exists('D:\ekpa\diplomatiki\Wizard-Werdna-Ring-Adventure\model_LSTM_Imp_15_12_21_11\ actor_model2.data-00000-of-00001'):
    print("actor model is loaded")
    agentoo7.actor.built = True
    agentoo7.actor.load_weights('D:\ekpa\diplomatiki\Wizard-Werdna-Ring-Adventure\model_LSTM_Imp_15_12_21_11\ actor_model2')
if exists('D:\ekpa\diplomatiki\Wizard-Werdna-Ring-Adventure\model_LSTM_Imp_15_12_21_11\ critic_model2.data-00000-of-00001'):
    print("critic model is loaded")
    agentoo7.critic.built = True
    agentoo7.critic.load_weights('D:\ekpa\diplomatiki\Wizard-Werdna-Ring-Adventure\model_LSTM_Imp_15_12_21_11\ critic_model2')
episode = 10000
ep_reward = []
total_avgr = []
dfrewards = []
...
for s in range(episodes_text,episode):
    ...
    while not done:
        ...
        if done or steps%batch_size ==0 and steps != 0:
            ...
            if len(replay_memory.replay_buffer) >= memory_size:
                batch = replay_memory.take_batch(batch_size = batch_size + h_step -1)
                train_states,train_playerstatus,train_gametexts,train_rewards,train_actions= agentoo7.preprocess1(batch,gamma)
        ...
        if done: 
            ...
            if s%100 == 0 and s != episodes_text:
                agentoo7.actor.save_weights('.\model_LSTM_Imp_15_12_21_11\ actor_model2')
                agentoo7.critic.save_weights('.\model_LSTM_Imp_15_12_21_11\ critic_model2')
                f = open('D:\ekpa\diplomatiki\Wizard-Werdna-Ring-Adventure\model_LSTM_Imp_15_12_21_11\episodes.txt','w')
                f.write(str(episodes_text + 100))
                f.close()
                f = open('D:\ekpa\diplomatiki\Wizard-Werdna-Ring-Adventure\model_LSTM_Imp_15_12_21_11\episodes.txt','r')
                episodes_text = int(f.read())
                f.close()
                f = open('D:\ekpa\diplomatiki\Wizard-Werdna-Ring-Adventure\model_LSTM_Imp_15_12_21_11\steps.txt','w')
