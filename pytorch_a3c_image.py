        ...
        while not done:
            ...
            if done:
                ...
                if episodes[0]%100==0 and episodes[0] != 0:
                    torch.save(global_model.state_dict(), 'D:\ekpa\diplomatiki\date_31_5_22_test_1\gen_model.pt')
                    d = dfrewards
                    d = list(d)
                    ...
                    destination = r'D:\ekpa\diplomatiki\date_31_5_22_test_1\agent.xlsx'
...
if __name__ == '__main__':
    ...
    if exists('D:\ekpa\diplomatiki\date_31_5_22_test_1\gen_model.pt'):
        global_model.load_state_dict(torch.load('D:\ekpa\diplomatiki\date_31_5_22_test_1\gen_model.pt'))
        global_model.eval()
